# Generated by Django 5.2.10 on 2026-01-21 04:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thank_you_text', wagtail.fields.RichTextField(blank=True, help_text='Text displayed after submission')),
                ('address', wagtail.fields.RichTextField(blank=True, help_text='Studio address')),
                ('map_embed_code', models.TextField(blank=True, help_text='Google Maps Embed HTML code')),
            ],
            options={
                'abstract': False,
            },
